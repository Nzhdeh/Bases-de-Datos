...
Escribe un script en T-SQL para realizar todas las operaciones siguientes, en ese orden y que se
ejecute de una sola vez sin errores.
Haz cada operación por separado.
PROBLEMA
